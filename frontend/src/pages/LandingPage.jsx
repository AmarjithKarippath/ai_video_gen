...
import { Mail, Zap, Video, Sparkles, Check, Globe, Mic, Users, Film, AlertCircle, X, Volume2, VolumeX } from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <header className="relative z-20 border-b border-white/10 bg-slate-950/40 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 sm:px-12 lg:px-20">
          ...
          <nav className="flex items-center gap-3">
            <Link
              to="/prompts"
              className="inline-flex items-center gap-2 rounded-lg border border-purple-400/30 bg-purple-500/10 px-4 py-2 text-sm font-medium text-purple-200 transition hover:border-purple-400/60 hover:bg-purple-500/20 hover:text-white"
            >
      ...
      {/* Hero Section */}
      <section className="relative pt-16 pb-32 px-6 sm:px-12 lg:px-20">
      ...
      <section className="relative py-20 px-6 sm:px-12 lg:px-20 bg-black/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-purple-500/30 bg-black aspect-[9/16] max-h-[560px] w-full">
              <video
                src="/videos/avatar-iv-demo.mp4"
                className="absolute inset-0 h-full w-full object-cover"
                autoPlay
                loop
                muted={isDemoMuted}
                playsInline
                aria-label="Avatar IV Technology Demo"
              />
              <button
                type="button"
                onClick={() => setIsDemoMuted((prev) => !prev)}
                aria-label={isDemoMuted ? 'Unmute video' : 'Mute video'}
                className="absolute bottom-4 right-4 z-10 inline-flex items-center justify-center rounded-full bg-black/60 p-3 text-white backdrop-blur-sm transition hover:bg-black/80"
              >
                {isDemoMuted ? <VolumeX className="h-5 w-5" /> : <Volume2 className="h-5 w-5" />}
              </button>
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="relative border-t border-white/10 bg-slate-950/50 px-6 py-14 sm:px-12 lg:px-20">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              to="/prompts"
              className="inline-flex items-center gap-2 text-sm font-medium text-purple-300 transition hover:text-white"
            >
              <Sparkles className="h-4 w-4" />
          ...
          <p className="mt-10 border-t border-white/10 pt-6 text-center text-sm text-gray-500">
            © {new Date().getFullYear()} Waveify.ai. All rights reserved.
          </p>
        </div>
      </footer>
